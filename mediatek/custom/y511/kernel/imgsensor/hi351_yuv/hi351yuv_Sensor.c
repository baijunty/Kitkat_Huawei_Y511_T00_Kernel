...
HI351_write_cmos_sensor(0x28,0x00);
HI351_write_cmos_sensor(0x29,0x00); //Indoor AWB Min Angle   50 jacky
HI351_write_cmos_sensor(0x2a,0x00);
HI351_write_cmos_sensor(0x2b,0xe6);
HI351_write_cmos_sensor(0x2c,0x00);
HI351_write_cmos_sensor(0x2d,0x20); // dark angle max     82 jacky
...
HI351_write_cmos_sensor(0x86,0x5e);//5e
...
HI351_write_cmos_sensor(0x45, 0x40);//YLVL_06  //38
HI351_write_cmos_sensor(0x46, 0x40);//YLVL_07
HI351_write_cmos_sensor(0x47, 0x40);//YLVL_08
HI351_write_cmos_sensor(0x48, 0x40);//YLVL_09
HI351_write_cmos_sensor(0x49, 0x40);//YLVL_10
HI351_write_cmos_sensor(0x4a, 0x40);//YLVL_11
...
HI351_write_cmos_sensor(0x2e, 0x85); //SATB_03  //88 jacky
HI351_write_cmos_sensor(0x2f, 0x95); //SATB_04
HI351_write_cmos_sensor(0x30, 0xa2); //SATB_05  //b8
...
HI351_write_cmos_sensor(0x3a, 0x80); //SATR_03   //90 jacky
HI351_write_cmos_sensor(0x3b, 0x95); //SATR_04
HI351_write_cmos_sensor(0x3c, 0xa2); //SATR_05   //98
...
HI351_write_cmos_sensor(0x30, 0x80); //LSC 03 ofs B   //jacky 80
HI351_write_cmos_sensor(0x31, 0x80); //LSC 03 ofs R   //jacky80
...
HI351_write_cmos_sensor(0x35, 0x80); //LSC 03 Gain R   ..80jacky
...
{printk("HI351_night_mode \n");
	
	if (HI351_gPVmode == KAL_TRUE) 
	{
...
printk("HI351_VEDIO_encode_mode:night \n");
	...
	printk("HI351_preview mode:night \n");
...
HI351_write_cmos_sensor(0x21, 0x01);
HI351_write_cmos_sensor(0x22, 0x00);
HI351_write_cmos_sensor(0x23, 0x07);
...
HI351_write_cmos_sensor(0x22, 0x03);  //Shading Height 1536
...
HI351_write_cmos_sensor(0x03, 0x20); //Page 20
HI351_write_cmos_sensor(0x24, 0x00); //EXP Max 4.00 fps
HI351_write_cmos_sensor(0x25, 0xc6);
HI351_write_cmos_sensor(0x26, 0x5d);
...
else 
{
	...
	printk("HI351_VEDIO_encode_mode:normal \n");
	...
	printk("HI351_preview mode:normal \n");
...
HI351_write_cmos_sensor(0x03, 0x20);//Page 20
HI351_write_cmos_sensor(0x24, 0x00); //EXP Max 8.33 fps
HI351_write_cmos_sensor(0x25, 0x57);
...
static void HI351_set_mirror_flip(kal_uint8 image_mirror)
{
printk("HI351_set_mirror_flip image_mirror is:%d\n\r",image_mirror);
...
{	
    ...
    printk("image_window->ExposureWindowWidth is:%d,image_window->ExposureWindowHeight is:%d,image_window->ImageTargetWidth is:%d,image_window->ImageTargetHeight is:%d\n\r",image_window->ExposureWindowWidth,image_window->ExposureWindowHeight,image_window->ImageTargetWidth,image_window->ImageTargetHeight);
...
HI351_write_cmos_sensor(0x03, 0x10);
HI351_write_cmos_sensor(0x48, 0x7c);//cons
HI351_write_cmos_sensor(0x03, 0x30);
...
HI351_write_cmos_sensor(0x03, 0xcf);//Adaptive On
HI351_write_cmos_sensor(0x10, 0xff);   // af
HI351_write_cmos_sensor(0x03, 0xc0);
HI351_write_cmos_sensor(0x33, 0x00);
HI351_write_cmos_sensor(0x32, 0x01);//DMA On
...
//#endif
	...
	pSensorInfo->VideoDelayFrame = 3; // 20
	//medify by zhaojr
	...
	switch (ScenarioId)
	{
		...
		pSensorInfo->SensorDataLatchCount= 2;
                /*ergate-004*/
		pSensorInfo->SensorGrabStartX = 1;//2;//HI351_PV_GRAB_START_X;//0; 
		pSensorInfo->SensorGrabStartY = 1;//2;//HI351_PV_GRAB_START_Y;//0;    
	#if 0//def MIPI_INTERFACE
		...
		pSensorInfo->SensorDataLatchCount= 2;
                /*ergate-004*/
		pSensorInfo->SensorGrabStartX = 1;//2;//HI351_FULL_GRAB_START_X;//0; 
		pSensorInfo->SensorGrabStartY = 1;//2;//HI351_FULL_GRAB_START_Y;//0;  
	#if 0//def MIPI_INTERFACE
        pSensorInfo->SensorMIPILaneNumber = SENSOR_MIPI_1_LANE;			
        pSensorInfo->MIPIDataLowPwr2HighSpeedTermDelayCount = 0; 
        pSensorInfo->MIPIDataLowPwr2HighSpeedSettleDelayCount = 14; 
...
UINT32 HI351Control(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow,
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	printk("HI351Control ScenarioId is:%d \n\r",ScenarioId);
	switch (ScenarioId)
	{
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
	case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
...
BOOL HI351_set_param_wb(UINT16 para)
{
    ...
    case AWB_MODE_AUTO:
		...
		HI351_write_cmos_sensor(0x18, 0x40); /*RgainMin*/
		HI351_write_cmos_sensor(0x19, 0xf0); /*RgainMax*/
		HI351_write_cmos_sensor(0x1a, 0x40); /*BgainMin*/
		HI351_write_cmos_sensor(0x1b, 0xf0); /*BgainMax*/
		HI351_write_cmos_sensor(0x03, 0xc5);
		HI351_write_cmos_sensor(0x10, 0xb1);
        break;
    case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
		...
		HI351_write_cmos_sensor(0x12, 0x03); /*adaptive off*/
		HI351_write_cmos_sensor(0x03, 0xc6); /*Page c6*/
		HI351_write_cmos_sensor(0x18, 0x90); /*indoor R gain Min*/
		HI351_write_cmos_sensor(0x19, 0x92); /*indoor R gain Max*/
		HI351_write_cmos_sensor(0x1a, 0x5f); /*indoor B gain Min*/
		HI351_write_cmos_sensor(0x1b, 0x61); /*indoor B gain Max*/
		HI351_write_cmos_sensor(0x03, 0xc5);
		HI351_write_cmos_sensor(0x10, 0xb1);
        break;
    case AWB_MODE_DAYLIGHT: //sunny
		...
		HI351_write_cmos_sensor(0x12, 0x03); /*adaptive off*/
		HI351_write_cmos_sensor(0x03, 0xc6); /*Page c6*/
		HI351_write_cmos_sensor(0x18, 0x75); /*indoor R gain Min*/
		HI351_write_cmos_sensor(0x19, 0x76); /*indoor R gain Max*/
		HI351_write_cmos_sensor(0x1a, 0x6a); /*indoor B gain Min*/
		HI351_write_cmos_sensor(0x1b, 0x6b); /*indoor B gain Max*/
		HI351_write_cmos_sensor(0x03, 0xc5);
		HI351_write_cmos_sensor(0x10, 0xb1);
        break;
    ...
    case AWB_MODE_FLUORESCENT:
		...
		HI351_write_cmos_sensor(0x12, 0x03); /*adaptive off*/
		HI351_write_cmos_sensor(0x03, 0xc6); /*Page c6*/
		HI351_write_cmos_sensor(0x18, 0x5d); /*indoor R gain Min*/
		HI351_write_cmos_sensor(0x19, 0x5e); /*indoor R gain Max*/
		HI351_write_cmos_sensor(0x1a, 0x94); /*indoor B gain Min*/
		HI351_write_cmos_sensor(0x1b, 0x95); /*indoor B gain Max*/
		HI351_write_cmos_sensor(0x03, 0xc5);
		HI351_write_cmos_sensor(0x10, 0xb1);
        break;	
	default:
...
BOOL HI351_set_param_banding(UINT16 para)
{printk("HI351_set_param_banding \n");
    kal_uint8 banding;

	switch (para)
	{
	case AE_FLICKER_MODE_50HZ:
		printk("AE_FLICKER_MODE_50HZt \n");
		HI351_Banding_setting = AE_FLICKER_MODE_50HZ;
		HI351_write_cmos_sensor(0x03,0x20);
		HI351_write_cmos_sensor(0x10,0x97);
	break;
	case AE_FLICKER_MODE_60HZ:		  
		printk("AE_FLICKER_MODE_60HZ \n");
...
BOOL HI351_set_param_exposure(UINT16 para)
{
  ...
  printk("HI351_set_param_exposure \n");
  HI351_write_cmos_sensor(0x03,0x10);
  ...
  case AE_EV_COMP_n07:
	  ...
	  break;
  case AE_EV_COMP_n03:
	  HI351_write_cmos_sensor(0x40,0x98);
	  break;
  case AE_EV_COMP_00:
	  HI351_write_cmos_sensor(0x40,0x83);
	  break;
  case AE_EV_COMP_03:

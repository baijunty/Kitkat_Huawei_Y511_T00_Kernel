...
//#define HI351_PV_PERIOD_PIXEL_NUMS			(HI351_FULL_PERIOD_PIXEL_NUMS / 2 + 116)
//#define HI351_PV_PERIOD_LINE_NUMS			(768+28)
//#define HI351_FULL_PERIOD_PIXEL_NUMS		(2048+132)	
//#define HI351_FULL_PERIOD_LINE_NUMS 		(1536)
...
#define HI351_IMAGE_SENSOR_PV_WIDTH   		(1024)//(640)//(1024) //640
#define HI351_IMAGE_SENSOR_PV_HEIGHT  		(768)//(480)//(768) //480


#define HI351_IMAGE_SENSOR_FULL_WIDTH     	(2048)//(1600-16)//(2048)
#define HI351_IMAGE_SENSOR_FULL_HEIGHT    	(1536)//(1536)
...
//#define HI351_FULL_GRAB_HEIGHT			(HI351_IMAGE_SENSOR_FULL_HEIGHT - 6)//24)
